...
const Navbar = ({ currentUser, setCurrentUser, loadingUser }) => {
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/80 border-b border-white/10 px-4 lg:px-8 py-4 transition-all">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              <span className="font-extrabold text-lg tracking-tight text-white">Appwrite</span>
            ...
            <span className="text-xs text-slate-400 font-medium">React 19 Authentication</span>
          </div>
        </div>

        {/* Center Links */}
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-300">
          <a href="#google-auth" className="hover:text-pink-400 transition-colors">Sign In / Sign Up</a>
          <a href="#setup-guide" className="hover:text-pink-400 transition-colors">Setup Guide</a>
          <a href="#session-info" className="hover:text-pink-400 transition-colors">User Profile</a>
        </nav>
          ...
          {loadingUser ? (
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 bg-slate-900/90 border border-emerald-500/30 px-3 py-1.5 rounded-xl text-sm">
                ...
                <span className="text-white font-medium max-w-[130px] truncate text-xs">
            ...
            <button
              ...
              disabled={authLoading}
              className="btn-primary text-sm shadow-xl shadow-pink-500/25 px-4 py-2"
            >
              ...
              <span>{authLoading ? "Redirecting..." : "Sign up with Google"}</span>
            </button>
          )}
        </div>
