...
const SignUp = ({ setCurrentUser }) => {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      // Create new user account (Appwrite automatically hashes passwords via Argon2/Bcrypt)
  ...
  const handleGoogleSignUp = () => {
    try {
      ...
      const redirectFailure = `${window.location.origin}/signup?auth_error=google_failed`;
